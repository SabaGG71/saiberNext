    ...
    <section className="py-24 px-4">
      <div className="container custom-container">
        ...
        <h2 className="text-6xl font-medium mt-6 text-center max-w-xl mx-auto">
          Questions? We&apos;ve got{" "}
          <span className="text-primary-400 font-bold">answers</span>
        </h2>
        <div className="mt-16 max-w-[900px] mx-auto flex flex-col gap-6">
          {faqs.map((faq, faqIndex) => (
            <div key={faq.question}>
              <div
                className={`bg-primary-800 cursor-pointer rounded-2xl border border-white/10 p-6`}
                onClick={() => toggleFAQ(faqIndex)}
              >
                <div className="flex max-sm:gap-6 justify-between items-center">
                  <h3 className="font-regular max-lg:text-2xl leading-[37px] max-sm:text-xl lg:text-[28px] lg:max-w-[500px] lg:leading-12">
                    {faq.question}
                  </h3>
                  <svg
                    ...
                    className={twMerge(
                      "feather feather-plus text-primary-400 lg:size-9 flex-shrink-0 transition duration-300",
                ...
                <AnimatePresence>
                  {selectedIndex === faqIndex && (
                    ...
                    >
                      <p className="text-white/50 lg:text-[18px] lg:max-w-[90%]">
                        {faq.answer}
                      </p>
                    </motion.div>
                  )}
